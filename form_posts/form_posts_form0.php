...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_posts/form_posts_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_posts_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_posts_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['link_info']['remove_border']) {
...
<?php
 include_once("form_posts_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_posts'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_posts'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_category_line" id="hidden_field_data_category" style="<?php echo $sStyleHidden_category; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_summary_label" id="hidden_field_label_summary" style="<?php echo $sStyleHidden_summary; ?>"><span id="id_label_summary"><?php echo $this->nm_new_label['summary']; ?></span></TD>
    <TD class="scFormDataOdd css_summary_line" id="hidden_field_data_summary" style="<?php echo $sStyleHidden_summary; ?>">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_media_label" id="hidden_field_label_media" style="<?php echo $sStyleHidden_media; ?>"><span id="id_label_media"><?php echo $this->nm_new_label['media']; ?></span></TD>
    <TD class="scFormDataOdd css_media_line" id="hidden_field_data_media" style="<?php echo $sStyleHidden_media; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_meta_label" id="hidden_field_label_meta" style="<?php echo $sStyleHidden_meta; ?>"><span id="id_label_meta"><?php echo $this->nm_new_label['meta']; ?></span></TD>
    <TD class="scFormDataOdd css_meta_line" id="hidden_field_data_meta" style="<?php echo $sStyleHidden_meta; ?>">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_slug_label" id="hidden_field_label_slug" style="<?php echo $sStyleHidden_slug; ?>"><span id="id_label_slug"><?php echo $this->nm_new_label['slug']; ?></span></TD>
    <TD class="scFormDataOdd css_slug_line" id="hidden_field_data_slug" style="<?php echo $sStyleHidden_slug; ?>">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_link_label" id="hidden_field_label_link" style="<?php echo $sStyleHidden_link; ?>"><span id="id_label_link"><?php echo $this->nm_new_label['link']; ?></span></TD>
    <TD class="scFormDataOdd css_link_line" id="hidden_field_data_link" style="<?php echo $sStyleHidden_link; ?>">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_published_label" id="hidden_field_label_published" style="<?php echo $sStyleHidden_published; ?>"><span id="id_label_published"><?php echo $this->nm_new_label['published']; ?></span></TD>
    <TD class="scFormDataOdd css_published_line" id="hidden_field_data_published" style="<?php echo $sStyleHidden_published; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['Lookup_published'][] = ''; ?>
 <option value=""></option>
 <option  value="Yes" <?php  if ($this->published == "Yes") { echo " selected" ;} ?>>Yes</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['Lookup_published'][] = 'Yes'; ?>
 <option  value="No" <?php  if ($this->published == "No") { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['Lookup_published'][] = 'No'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['btn_label']['update'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_posts");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_posts");
 parent.scAjaxDetailHeight("form_posts", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_posts']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
