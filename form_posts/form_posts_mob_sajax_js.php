  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_posts_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate title
  function do_ajax_form_posts_mob_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_posts_mob_validate_title(var_title, var_script_case_init, do_ajax_form_posts_mob_validate_title_cb);
  } // do_ajax_form_posts_mob_validate_title

  function do_ajax_form_posts_mob_validate_title_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_posts_mob_validate_title_cb

  // ---------- Validate category
  function do_ajax_form_posts_mob_validate_category()
  {
    var nomeCampo_category = "category";
    var var_category = scAjaxGetFieldSelect(nomeCampo_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_posts_mob_validate_category(var_category, var_script_case_init, do_ajax_form_posts_mob_validate_category_cb);
  } // do_ajax_form_posts_mob_validate_category

  function do_ajax_form_posts_mob_validate_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_posts_mob_validate_category_cb

  // ---------- Validate summary
  function do_ajax_form_posts_mob_validate_summary()
  {
    var nomeCampo_summary = "summary";
    var var_summary = scAjaxGetFieldText(nomeCampo_summary);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_posts_mob_validate_summary(var_summary, var_script_case_init, do_ajax_form_posts_mob_validate_summary_cb);
  } // do_ajax_form_posts_mob_validate_summary

  function do_ajax_form_posts_mob_validate_summary_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "summary";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_posts_mob_validate_summary_cb

  // ---------- Validate media
  function do_ajax_form_posts_mob_validate_media()
  {
    var nomeCampo_media = "media";
    var var_media = scAjaxGetFieldText(nomeCampo_media);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_posts_mob_validate_media(var_media, var_script_case_init, do_ajax_form_posts_mob_validate_media_cb);
  } // do_ajax_form_posts_mob_validate_media

  function do_ajax_form_posts_mob_validate_media_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "media";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_posts_mob_validate_media_cb

  // ---------- Validate meta
  function do_ajax_form_posts_mob_validate_meta()
  {
    var nomeCampo_meta = "meta";
    var var_meta = scAjaxGetFieldText(nomeCampo_meta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_posts_mob_validate_meta(var_meta, var_script_case_init, do_ajax_form_posts_mob_validate_meta_cb);
  } // do_ajax_form_posts_mob_validate_meta

  function do_ajax_form_posts_mob_validate_meta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "meta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_posts_mob_validate_meta_cb

  // ---------- Validate slug
  function do_ajax_form_posts_mob_validate_slug()
  {
    var nomeCampo_slug = "slug";
    var var_slug = scAjaxGetFieldText(nomeCampo_slug);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_posts_mob_validate_slug(var_slug, var_script_case_init, do_ajax_form_posts_mob_validate_slug_cb);
  } // do_ajax_form_posts_mob_validate_slug

  function do_ajax_form_posts_mob_validate_slug_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "slug";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_posts_mob_validate_slug_cb

  // ---------- Validate link
  function do_ajax_form_posts_mob_validate_link()
  {
    var nomeCampo_link = "link";
    var var_link = scAjaxGetFieldText(nomeCampo_link);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_posts_mob_validate_link(var_link, var_script_case_init, do_ajax_form_posts_mob_validate_link_cb);
  } // do_ajax_form_posts_mob_validate_link

  function do_ajax_form_posts_mob_validate_link_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "link";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_posts_mob_validate_link_cb

  // ---------- Validate published
  function do_ajax_form_posts_mob_validate_published()
  {
    var nomeCampo_published = "published";
    var var_published = scAjaxGetFieldSelect(nomeCampo_published);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_posts_mob_validate_published(var_published, var_script_case_init, do_ajax_form_posts_mob_validate_published_cb);
  } // do_ajax_form_posts_mob_validate_published

  function do_ajax_form_posts_mob_validate_published_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "published";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_posts_mob_validate_published_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_posts_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_posts_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_title = scAjaxGetFieldText("title");
    var var_category = scAjaxGetFieldSelect("category");
    var var_summary = scAjaxGetFieldText("summary");
    var var_media = scAjaxGetFieldText("media");
    var var_meta = scAjaxGetFieldText("meta");
    var var_slug = scAjaxGetFieldText("slug");
    var var_link = scAjaxGetFieldText("link");
    var var_published = scAjaxGetFieldSelect("published");
    ...
    scAjaxProcOn();
    x_ajax_form_posts_mob_submit_form(var_title, var_category, var_summary, var_media, var_meta, var_slug, var_link, var_published, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_posts_mob_submit_form_cb);
  } // do_ajax_form_posts_mob_submit_form

  function do_ajax_form_posts_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_posts_mob_submit_form_cb_after_alert);
  } // do_ajax_form_posts_mob_submit_form_cb
  function do_ajax_form_posts_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_posts_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_posts_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_posts_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_posts_mob_navigate_form();
    }
  }

  function perform_ajax_form_posts_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_posts_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_posts_mob_navigate_form_cb);
  } // do_ajax_form_posts_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_posts_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_posts_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_posts_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_posts_mob_navigate_form_cb
  function do_ajax_form_posts_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_posts_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_posts_mob_navigate_form_cb_after_alert

  function sc_hide_form_posts_mob_form()
  {
  ...
  ajax_field_list[2] = "summary";
  ajax_field_list[3] = "media";
  ajax_field_list[4] = "meta";
  ajax_field_list[5] = "slug";
  ajax_field_list[6] = "link";
  ajax_field_list[7] = "published";
  ...
  var ajax_error_list = {
    ...
    "category": {"label": "Category", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "summary": {"label": "Summary", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "media": {"label": "Media", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "meta": {"label": "Meta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "slug": {"label": "Slug", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "link": {"label": "Link", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "published": {"label": "Published", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["media"][1] = "media";
  ajax_field_mult["meta"][1] = "meta";
  ajax_field_mult["slug"][1] = "slug";
  ajax_field_mult["link"][1] = "link";
  ajax_field_mult["published"][1] = "published";
  ...
  var ajax_field_id = {
    ...
    "media": new Array("hidden_field_label_media", "hidden_field_data_media"),
    "meta": new Array("hidden_field_label_meta", "hidden_field_data_meta"),
    "slug": new Array("hidden_field_label_slug", "hidden_field_data_slug"),
    "link": new Array("hidden_field_label_link", "hidden_field_data_link"),
    "published": new Array("hidden_field_label_published", "hidden_field_data_published")
  };
