...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["priv_admin" + iSeqRow] && scEventControl_data["priv_admin" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["priv_admin" + iSeqRow] && scEventControl_data["priv_admin" + iSeqRow]["change"]) {
    return true;
  }
  return false;
