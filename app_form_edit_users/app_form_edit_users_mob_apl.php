...
//---------------------------------------------------------
   ...
   if (isset($this->Field_no_validate['active'])) {
    ...
    function ValidateField_priv_admin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['priv_admin'])) {
       return;
   }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
...
sc_send_mail_api(array(
    'profile' => '',
		...
		'settings' => [
				...
				'smtp_port'     => '465',
				'smtp_user'     => 'hello@nareshshahi.com',
				'smtp_password' => 'Pearl379',
				'from_email'    => 'hello@nareshshahi.com',
				'from_name'    => 'hello@nareshshahi.com',
		],
    'message' => [
