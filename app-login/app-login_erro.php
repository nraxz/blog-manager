...
function app_login_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['app-login']['contr_erro']) && $_SESSION['scriptcase']['app-login']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            {
                $inicial_app_login->contr_app_login->NM_ajax_info['errList']['geral_app-login'][] = $msg;
                return;
            }
...
function app_login_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['app-login'])  && '' != $_SESSION['scriptcase']['error_icon']['app-login'])  ? $_SESSION['scriptcase']['error_icon']['app-login']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['app-login']) && '' != $_SESSION['scriptcase']['error_close']['app-login']) ? $_SESSION['scriptcase']['error_close']['app-login'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['app-login']) && '' != $_SESSION['scriptcase']['error_span_title']['app-login']) ? $_SESSION['scriptcase']['error_span_title']['app-login'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['app-login']) && '' != $_SESSION['scriptcase']['error_icon_title']['app-login']) ? $_SESSION['scriptcase']['error_icon_title']['app-login'] : '';
?>
