...
//
   if (!session_id())
   {
   include_once('app-login_session.php');
   ...
   @session_start() ;
       ...
       {
          include_once('app-login_mob.php');
          exit;
       }
   }
   ...
   $_SESSION['scriptcase']['app-login']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['app-login']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['app-login']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['app-login']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['app-login']['glo_nm_path_cache']  = "";
   $_SESSION['scriptcase']['app-login']['glo_nm_path_doc']        = "";
   $NM_dir_atual = getcwd();
   ...
   //check prod
   if(empty($_SESSION['scriptcase']['app-login']['glo_nm_path_prod']))
   {
           /*check prod*/$_SESSION['scriptcase']['app-login']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
   }
   //check img
   if(empty($_SESSION['scriptcase']['app-login']['glo_nm_path_imagens']))
   {
           /*check img*/$_SESSION['scriptcase']['app-login']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
   }
   //check tmp
   if(empty($_SESSION['scriptcase']['app-login']['glo_nm_path_imag_temp']))
   {
           /*check tmp*/$_SESSION['scriptcase']['app-login']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   //check cache
   if(empty($_SESSION['scriptcase']['app-login']['glo_nm_path_cache']))
   {
           /*check cache*/$_SESSION['scriptcase']['app-login']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
   }
   //check doc
   if(empty($_SESSION['scriptcase']['app-login']['glo_nm_path_doc']))
   {
           /*check doc*/$_SESSION['scriptcase']['app-login']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
   }
...
// 
      ...
      $this->path_prod       = $_SESSION['scriptcase']['app-login']['glo_nm_path_prod'];
      $this->path_imagens    = $_SESSION['scriptcase']['app-login']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['app-login']['glo_nm_path_imag_temp'];
      $this->path_cache      = $_SESSION['scriptcase']['app-login']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['app-login']['glo_nm_path_doc'];
      ...
      if (isset($_SESSION['scriptcase']['app-login']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['app-login']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['app-login']['actual_lang']) || $_SESSION['scriptcase']['app-login']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['app-login']['actual_lang'] = $this->str_lang;
...
<?php
      ...
      if (isset($_SESSION['scriptcase']['app-login']['session_timeout']['redir'])) {
...
';
          ...
          if ($_SESSION['scriptcase']['app-login']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['app-login']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['app-login']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['app-login']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['app-login']['session_timeout']);
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['app-login']['session_timeout']['redir']))
      {
      ...
      if (!isset($_SESSION['sc_session'][$script_case_init]['app-login']['iframe_menu'])) {
          $_SESSION['sc_session'][$script_case_init]['app-login']['iframe_menu'] = "";
      }
      if (!isset($_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'])) {
          $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] = "";
      }
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
          ...
          echo $str_message;
          if (!$_SESSION['sc_session'][$script_case_init]['app-login']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['app-login']['sc_outra_jan']) || $_SESSION['sc_session'][$script_case_init]['app-login']['sc_outra_jan'] != 'app-login')) 
          { 
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $this->link_app_login_inline = $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('app-login') . "/app-login_inline.php";
      if ($_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['app-login']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["app-login"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["app-login"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app-login']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app-login']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app-login']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app-login']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app-login']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app-login']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app-login']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app-login']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app-login']['link_info']['remove_border'] = true;
        }
...
// 
      ...
      if(function_exists('set_php_timezone'))  set_php_timezone('app-login'); 
      ...
      if ((isset($inicial_app_login->contr_app_login->NM_ajax_flag) && $inicial_app_login->contr_app_login->NM_ajax_flag) || (isset($_SESSION['sc_session'][$this->sc_page]['app-login']['embutida_call']) && $_SESSION['sc_session'][$this->sc_page]['app-login']['embutida_call']) || $NM_run_iframe == 1)
      {
           $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['app-login']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['app-login']['initialize'])  
      { 
          $this->conectDB();
      }
   }
   ...
   function init2()
   {
      if (isset($_SESSION['sc_session'][$this->sc_page]['app-login']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['app-login']['initialize'])  
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app-login']['initialize'] = false;
          $this->Db->Close(); 
      } 
      $this->conectDB();
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['app-login']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['app-login']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['app-login']['glo_nm_conexao']) && $_SESSION['scriptcase']['app-login']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['app-login']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['app-login']['glo_nm_perfil']) && $_SESSION['scriptcase']['app-login']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['app-login']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['app-login']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['app-login']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['app-login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app-login']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['app-login']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['app-login']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['app-login']['glo_nm_perfil'];
      }
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
          ...
          $str_message = str_replace('{v_str_btn_inside}', '', $str_message);
          echo $str_message;
          if (!$_SESSION['sc_session'][$this->sc_page]['app-login']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['app-login']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['app-login']['sc_outra_jan'] != 'app-login')) 
          { 
              if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno'])) 
              { 
?>
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app-login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app-login']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app-login']['glo_nm_conexao'], $this->root . $this->path_prod, 'BlogManager', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app-login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app-login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app-login']['glo_nm_conexao'], $this->root . $this->path_prod, 'BlogManager', 1, $this->force_db_utf8);
    }
    else {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['app-login']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['app-login']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['app-login']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['app-login']['SC_sep_date1'];
           }
...
class app_login_edit
{
    ...
    function inicializa()
    {
        ...
        require_once("app-login_apl.php");
...
//
    ...
    {
        $_SESSION['sc_session'][$script_case_init]['app-login']['where_filter'] = $SC_where_pdf;
    }

    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['app-login']['session_timeout']['redir']))
    {
    ...
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['lig_edit_lookup']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['lig_edit_lookup']     = false;
        $_SESSION['sc_session'][$script_case_init]['app-login']['lig_edit_lookup_cb']  = '';
        $_SESSION['sc_session'][$script_case_init]['app-login']['lig_edit_lookup_row'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_call']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_call'] = false;
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_proc']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_proc'] = false;
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_form_insert']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_form_insert'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_form_update']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_form_update'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_form_delete']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_form_delete'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_form_btn_nav']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_form_btn_nav'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_grid_edit']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_grid_edit'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_grid_edit_link']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_grid_edit_link'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_qtd_reg']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_qtd_reg'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_tp_pag']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_liga_tp_pag'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['app-login']['run_modal']))
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['run_modal'] = isset($_GET['nmgp_url_saida']) && 'modal' == $_GET['nmgp_url_saida'];
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_proc'])
    {
        return;
    }
    if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_parms']))
    { 
        $tmp_nmgp_parms = '';
        ...
        $nmgp_parms = $tmp_nmgp_parms . $_SESSION['sc_session'][$script_case_init]['app-login']['embutida_parms'];
    ...
    elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app-login']['parms']))
    {
    ...
    if (isset($_SESSION['sc_session'][$script_case_init]['app-login']['iframe_menu']))
    {
        $salva_iframe = $_SESSION['sc_session'][$script_case_init]['app-login']['iframe_menu'];
        unset($_SESSION['sc_session'][$script_case_init]['app-login']['iframe_menu']);
    }
    if (isset($_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe']))
    {
        $salva_run = $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'];
        unset($_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe']);
    }
    if (isset($nm_run_menu) && $nm_run_menu == 1)
    {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "app-login";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'app-login' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['app-login']['iframe_menu']  = true;
        $_SESSION['sc_session'][$script_case_init]['app-login']['mostra_cab']   = "S";
        $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe']   = "N";
        $_SESSION['sc_session'][$script_case_init]['app-login']['retorno_edit'] = "";
    }
    else
    {
        $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe']  = $salva_run;
        $_SESSION['sc_session'][$script_case_init]['app-login']['iframe_menu'] = $salva_iframe;
    }

    if (!isset($_SESSION['sc_session'][$script_case_init]['app-login']['db_changed']))
    {
        $_SESSION['sc_session'][$script_case_init]['app-login']['db_changed'] = false;
    }
    ...
    if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'app-login')
    {
        $_SESSION['sc_session'][$script_case_init]['app-login']['sc_outra_jan'] = true;
    ...
    if (isset($nmgp_outra_jan) && $nmgp_outra_jan == 'true')
    {
        ...
        {
            $_SESSION['sc_session'][$script_case_init]['app-login']['sc_modal'] = true;
            $nm_url_saida = "app-login_fim.php"; 
        }
        $nm_apl_dependente = 0;
        $_SESSION['sc_session'][$script_case_init]['app-login']['sc_outra_jan'] = true;
    }
    ...
    if (isset($_SESSION['scriptcase']['app-login']['session_timeout']['lang'])) {
        $STR_lang = $_SESSION['scriptcase']['app-login']['session_timeout']['lang'];
    }
    ...
    if (!isset($_SESSION['sc_session'][$script_case_init]['app-login']['initialize']))
    {
        $_SESSION['sc_session'][$script_case_init]['app-login']['initialize'] = true;
    }
    elseif (!isset($_SERVER['HTTP_REFERER']))
    {
        $_SESSION['sc_session'][$script_case_init]['app-login']['initialize'] = false;
    }
    ...
    if (isset($_SESSION['sc_session'][$script_case_init]['app-login']['first_time']))
    {
        $_SESSION['sc_session'][$script_case_init]['app-login']['first_time'] = false;
    }
    else
    {
        $_SESSION['sc_session'][$script_case_init]['app-login']['first_time'] = true;
    }

    $_SESSION['sc_session'][$script_case_init]['app-login']['menu_desenv'] = false;   
    if (!defined("SC_ERROR_HANDLER"))
    {
        define("SC_ERROR_HANDLER", 1);
    }
    include_once(dirname(__FILE__) . "/app-login_erro.php");
    ...
    else
    {
        if (!empty($nmgp_opcao))  
        {
            $_SESSION['sc_session'][$script_case_init]['app-login']['opcao'] = $nmgp_opcao ; 
        }
        ...
        if (!empty($_SESSION['sc_session'][$script_case_init]['app-login']['volta_redirect_apl']))
        {
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['app-login']['volta_redirect_apl']; 
            $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['app-login']['volta_redirect_tp']; 
            $_SESSION['sc_session'][$script_case_init]['app-login']['volta_redirect_apl'] = "";
            $_SESSION['sc_session'][$script_case_init]['app-login']['volta_redirect_tp'] = "";
            $nm_url_saida = "app-login_fim.php"; 
        }
        elseif (isset($_SESSION['sc_session'][$script_case_init]['app-login']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['app-login']['sc_outra_jan'] == 'true')
        {
               $nm_url_saida = "app-login_fim.php"; 
        }
        elseif ($_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "R")
        {
           $nm_url_saida = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : ""; 
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            $nm_saida_global = $nm_url_saida;
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['app-login']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['app-login']['retorno_edit'] = $nmgp_url_saida ; 
            } 
            if (!empty($_SESSION['sc_session'][$script_case_init]['app-login']['retorno_edit'])) 
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['app-login']['retorno_edit'] . "?script_case_init=" . $script_case_init;  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
            ...
            if ($_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "R" && (!isset($_SESSION['sc_session'][$script_case_init]['app-login']['embutida_call']) || !$_SESSION['sc_session'][$script_case_init]['app-login']['embutida_call']))
            { 
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['app-login']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "R")
        {
            if (!isset($nm_saida_global)) {
                $nm_saida_global = $nm_url_saida;
            }
            $_SESSION['sc_session'][$script_case_init]['app-login']['volta_php'] = $nm_url_saida;
            $_SESSION['sc_session'][$script_case_init]['app-login']['volta_apl'] = $nm_saida_global;
            $_SESSION['sc_session'][$script_case_init]['app-login']['volta_ss']  = (isset($_SESSION['scriptcase']['sc_url_saida'][$script_case_init])) ? $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] : "";
            $_SESSION['sc_session'][$script_case_init]['app-login']['volta_dep'] = (isset($nm_apl_dependente)) ? $nm_apl_dependente : "";
            $_SESSION['sc_session'][$script_case_init]['app-login']['volta_tp']  = (isset($_SESSION['scriptcase']['sc_tp_saida'])) ? $_SESSION['scriptcase']['sc_tp_saida'] : "";
        }
        $nm_url_saida      = (isset($_SESSION['sc_session'][$script_case_init]['app-login']['volta_php'])) ? $_SESSION['sc_session'][$script_case_init]['app-login']['volta_php'] : "";
        $nm_apl_dependente = (isset($_SESSION['sc_session'][$script_case_init]['app-login']['volta_dep'])) ? $_SESSION['sc_session'][$script_case_init]['app-login']['volta_dep'] : "";
        $nm_saida_global   = $nm_url_saida;
        if ($_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "R" && !empty($_SESSION['sc_session'][$script_case_init]['app-login']['volta_ss'])) 
        { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['app-login']['volta_ss'];
            $_SESSION['scriptcase']['sc_tp_saida']  = $_SESSION['sc_session'][$script_case_init]['app-login']['volta_tp'];
        } 
        if ($_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] == "F" || $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] == "R") 
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['app-login']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['app-login']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init; 
            } 
        } 
        if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app-login']['run_iframe'] != "R") 
        { 
            $_SESSION['sc_session'][$script_case_init]['app-login']['menu_desenv'] = true;   
        } 
    }
    if (isset($nmgp_redir)) 
    { 
        $_SESSION['sc_session'][$script_case_init]['app-login']['redir'] = $nmgp_redir;   
    } 
    if (isset($nmgp_outra_jan) && $nmgp_outra_jan == 'true')
    {
        $_SESSION['sc_session'][$script_case_init]['app-login']['sc_outra_jan'] = true;
    ...
    if (isset($_SESSION['sc_session'][$script_case_init]['app-login']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['app-login']['sc_outra_jan'])
    {
        $nm_apl_dependente = 0;
    }
    ...
    if (!isset($_SESSION['scriptcase']['app-login']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['app-login']) || $_SESSION['scriptcase']['sc_apl_seg']['app-login'] != "on"))
    { 
        $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
        $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['app-login']['iframe_menu']) ? false : true;
...
<?php
    ...
    {
        include_once(dirname(__FILE__) . '/app-login_sajax.php');
        define('SC_SAJAX_LOADED', 'YES');
    }
    if (!class_exists('Services_JSON'))
    {
        include_once(dirname(__FILE__) . '/app-login_json.php');
    }
