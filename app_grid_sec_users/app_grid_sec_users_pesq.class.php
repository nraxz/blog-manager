...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      {
         $tmp_pos = (is_string($active)) ? strpos($active, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      {
         $tmp_pos = (is_string($priv_admin)) ? strpos($priv_admin, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "BlogManager/app_grid_sec_users";
   ...
   function trata_campos()
   {
      ...
      {
         $this->monta_condicao("active", $active_cond, $active, "", "active", "VARCHAR", false);
      }
      ...
      {
         $this->monta_condicao("priv_admin", $priv_admin_cond, $priv_admin, "", "priv_admin", "VARCHAR", false);
      }
   }
