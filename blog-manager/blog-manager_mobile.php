...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["blog-manager"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc9_Guava/Sc9_Guava_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc9_Guava/Sc9_Guava_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["blog-manager"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["blog-manager"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($blog-manager_menuData["data"]) && is_array($blog-manager_menuData["data"]) && !empty($blog-manager_menuData["data"]))
    {
        foreach($blog-manager_menuData["data"] as $arr_item)
        {
...
<div class="scMenuHHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    ...
    <?php
        escreveMenuMobile($blog-manager_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
