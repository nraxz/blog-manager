...
function scEventControl_init(iSeqRow) {
  scEventControl_data["name_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["category_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}

function scEventControl_active(iSeqRow) {
  if (scEventControl_data["name_" + iSeqRow] && scEventControl_data["name_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["name_" + iSeqRow] && scEventControl_data["name_" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_category_' + iSeqRow).bind('blur', function() { sc_form_categories_category__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_categories_category__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_categories_category__onfocus(this, iSeqRow) });
  $('#id_sc_field_name_' + iSeqRow).bind('blur', function() { sc_form_categories_name__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_categories_name__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_categories_name__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_categories_category__onblur(oThis, iSeqRow) {
  do_ajax_form_categories_validate_category_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_categories_category__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_categories_category__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_categories_name__onblur(oThis, iSeqRow) {
  do_ajax_form_categories_validate_name_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_categories_name__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_categories_name__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	displayChange_field("name_", "", status);
}

function displayChange_row(row, status) {
	displayChange_field_name_(row, status);
...
function displayChange_field_name_(row, status) {
    var fieldId;
}
