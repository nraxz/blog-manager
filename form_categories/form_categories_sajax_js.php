...
?>
  ...
  // ---------- Validate name_
  function do_ajax_form_categories_validate_name_(iNumLinha)
  {
    var nomeCampo_name_ = "name_" + iNumLinha;
    var var_name_ = scAjaxGetFieldText(nomeCampo_name_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categories_validate_name_(var_name_, iNumLinha, var_script_case_init, do_ajax_form_categories_validate_name__cb);
  } // do_ajax_form_categories_validate_name_

  function do_ajax_form_categories_validate_name__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categories_validate_name__cb

  // ---------- Validate category_
  function do_ajax_form_categories_validate_category_(iNumLinha)
  {
    var nomeCampo_category_ = "category_" + iNumLinha;
    var var_category_ = scAjaxGetFieldText(nomeCampo_category_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categories_validate_category_(var_category_, iNumLinha, var_script_case_init, do_ajax_form_categories_validate_category__cb);
  } // do_ajax_form_categories_validate_category_

  function do_ajax_form_categories_validate_category__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categories_validate_category__cb
  ...
  function do_ajax_form_categories_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categories_backup_line(var_category_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_categories_backup_line_cb);
...
?>
  ...
  {
    var var_category_ = document.F2.category_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_categories_table_refresh(var_category_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categories_table_refresh_cb);
  ...
  function do_ajax_form_categories_table_refresh_cb(sResp)
  {
    ...
    document.F2.category_.value = scAjaxGetKeyValue("category_");
...
?>
    x_ajax_form_categories_submit_form(var_name_, var_category_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_categories_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_categories_navigate_form, function() {});
    } else {
  ...
  function perform_ajax_form_categories_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_categories_navigate_form(var_category_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categories_navigate_form_cb);
...
?>
  function do_ajax_form_categories_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.category_.value = scAjaxGetKeyValue("category_" + var_last_index);
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_error_list["name_" + iNumLinha] = {"label": "Name<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["category_" + iNumLinha] = {"label": "Category<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["name_" + iRow] || "on" == ajax_error_count["category_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_name_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["name_" + iRow] && "off" == ajax_error_count["category_" + iRow]))
    {
      if (bErrorRow)
      {
      ...
      $("#hidden_field_data_name_" + iRow).removeClass("scFormErrorLine");
