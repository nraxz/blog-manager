<?php
@session_start() ;
$_SESSION['scriptcase']['grid_posts']['sc_process_barr'] = true;
require_once('../grid_posts/index.php');
unset($_SESSION['scriptcase']['grid_posts']['sc_process_barr']);
$ExportCtrl = new grid_posts_export_control;
$ExportCtrl->Export_barr();

class grid_posts_export_control
{
