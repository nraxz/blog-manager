...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["BlogManager_____grid_posts"]))
   {
      unset($_SESSION['session_sec_aplicacao']["BlogManager_____grid_posts"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_posts'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_posts']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_posts']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_posts']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_posts']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_posts']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_posts']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_posts']['embutida_filho'] as $ind => $sc_init)
          {
